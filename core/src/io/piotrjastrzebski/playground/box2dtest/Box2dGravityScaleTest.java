 ...
 */
public class Box2dGravityScaleTest extends BaseScreen {
	...
	public Box2dGravityScaleTest (GameReset game) {
		super(game);
	...
	private void reset () {
		...
		for (int i = 0; i < 3; i++) {
			createBox(-8 + i * 8, 8, 0, .25f + i, box);
		}
	}

	private void createBox (float x, float y, float rotation, float gravityScale, Texture texture) {
	...
	public static void main (String[] args) {
		PlaygroundGame.start(args, Box2dGravityScaleTest.class);
	}
}
