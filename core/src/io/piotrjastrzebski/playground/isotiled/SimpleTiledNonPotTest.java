 ...
 */
public class SimpleTiledNonPotTest extends BaseScreen {
	public final static float SCALE = 58f; // size of single tile in pixels
	public final static float INV_SCALE = 1.f/SCALE;
	public final static float VP_WIDTH = 1280/SCALE;
	public final static float VP_HEIGHT = 720/SCALE;

	OrthogonalTiledMapRenderer mapRenderer;
	public SimpleTiledNonPotTest (GameReset game) {
		super(game);
		...
		TiledMap map = new TmxMapLoader().load("tiled/simple58.tmx");
